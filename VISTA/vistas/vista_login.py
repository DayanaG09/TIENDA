...
class Login:
    ...
    def ventana_ingreso(self):
        ...
        self.imagen_login = self.interface_pictures(r"VISTA/imagenes/logo_haybet_salud.jpeg", 210, 150)

        frameInicioSesion=tk.Frame(self.ventanaLogin)
        frameInicioSesion.config(bg="#719ae2",width=400,height=500)
        ...
        frameLogin=tk.Frame(frameInicioSesion, bg="#719ae2")
        ...
        labelNombre=tk.Label(frameLogin, bg= "#719ae2",text="Nombre")
        ...
        labelDocumento=tk.Label(frameLogin , bg= "#719ae2",text="Documento")
        ...
        botonIngresar=tk.Button(frameLogin,text="Iniciar sesion",command=lambda:self.funcion_ingresar(), bg="#d6022a")
        ...
        try:
            ...
            try:
                    ...
                    if validacion_usuario is True:
                        ...
                        self.objInterfaz=Interfaz(self.objControlador,self.cargo)
                        self.objInterfaz.ventana_home()
                    else:
